...
import SecondaryButton from '../../components/button-secondary-false';
import { useParallax } from 'react-scroll-parallax';
import Calendly from '../../components/calendly-header';
        ...
        <AboutContentWrapper>
          <AnimationOnScroll animateIn="bezier-animation" animateOnce={true}>
            ...
            <SplashButtonStack>
              ...
              <SplashButtonVertical>
                <Calendly style={{marginTop: '10px'}}>
                  <SecondaryButton icon={rightArrow}>Schedule a Free Consultation</SecondaryButton>
                </Calendly>
              </SplashButtonVertical>
