...
const FiveIcon = <FcCurrencyExchange style={style} />;
...
const FiveContent = ({ selectedIndex,  setSelected }) => {
    return (
    <div style={{flex: 1}}>
...
class Five extends React.Component {
    ...
    render() {
        return (
            <BlogPost icon={FiveIcon} videoID={""} title={"Dealing with Money"} subtitle={"Currencies, Exchange Fees, Banks"} content={<FiveContent selectedIndex={this.state.selectedIndex} setSelected={(index) => this.setSelected(index)} />} />
        );
    }
