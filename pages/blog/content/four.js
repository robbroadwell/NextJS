...
const FourIcon = <FcMoneyTransfer style={style} />;
...
const FourContent = ({ selectedIndex,  setSelected }) => {
    return (
    <div style={{flex: 1}}>
...
class Four extends React.Component {
    ...
    render() {
        return (
            <BlogPost icon={FourIcon} videoID={""} title={"Paying Taxes"} subtitle={"Guide for the American Expat"} content={<FourContent selectedIndex={this.state.selectedIndex} setSelected={(index) => this.setSelected(index)} />} />
        );
    }
